...
git clone https://github.com/hyperpolymath/filesoup.git cd filesoup
...
toolbox create filesoup-dev toolbox enter filesoup-dev # Install
...
filesoup/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ # Library code
