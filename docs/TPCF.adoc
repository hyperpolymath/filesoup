...
FSLint uses the *Tri-Perimeter Contribution Framework* for graduated
access control and trust management.

=== Overview

TPCF provides three distinct perimeters of access, each with different
...
[arabic]
. *Consistent Contributions*: 3+ months of quality PRs
. *Community Engagement*: Helpful in issues/discussions
. *Technical Understanding*: Demonstrated codebase knowledge
. *Good Judgment*: Thoughtful code reviews and suggestions
...
[arabic]
. *Long-term Commitment*: 6+ months in Perimeter 2
. *Deep Expertise*: Significant architectural contributions
. *Leadership*: Mentoring, RFC authorship
. *Trust*: Unanimous vote from Perimeter 1
...
_Seeking additional P1 members from qualified P2 contributors_

==== Perimeter 2 (Trusted Contributors)

_None yet - first P2 members will be promoted from active P3
contributors_

==== Perimeter 3 (Community)

*Everyone is welcome!* Join us at: - GitHub Issues:
https://github.com/Hyperpolymath/file-soup/issues - GitHub Discussions:
https://github.com/Hyperpolymath/file-soup/discussions

=== FAQ

==== Can I go directly from P3 to P1?

Rarely. In exceptional cases (e.g., significant architectural
contribution, existing maintainer of similar project), but typically
...
Yes, if: - *Inactivity*: 6+ months without participation → demoted one
perimeter - *Code of Conduct violation*: May result in removal -
