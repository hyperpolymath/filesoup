...
# Contributing — filesoup

## Audience

Developers working **on** `filesoup`. For consumers (people calling or
...
``` bash
git clone git@github.com:hyperpolymath/filesoup.git
cd filesoup
...
- Bugs in `filesoup`: file at `hyperpolymath/filesoup/issues`.
